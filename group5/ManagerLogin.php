<?php
// Kuanzisha muunganiko na database
...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if ($result->num_rows > 0) {
     ...
     echo ("You have not registered, please register here.");
     exit();
    }
...
<form action="ManagerLogin.php" name="myForm" id="loginForm" onsubmit="return validateForm()" method="post">
    <h1>MANAGER LOGIN FORM</h1>
    <p>Please fill in this form to login into you account as a manager.</p>
    <hr>
    ...
    <div class="container signin">
      <p>Don't have an account? <a href="ManagerRegistration.php">Register</a>.</p>
    </div>
</form>
</section>
<footer>
