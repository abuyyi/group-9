...
.alert{
  ...
  <body>
    ...
    <ul>
          ...
          <li>
            <a href="BanquetHall.php" class="active">Banquet halls</a>
          </li>
          <li>
          ...
          <h1 class="page-title">Banquet Hall</h1>
          <?php
...
<p class="price">For Feedback And Reviews, Contact Us Through : <strong>'. htmlspecialchars($row['phone_number']) .'</strong></p>  
  ...
  <div class="right-col">
        <img src="' . htmlspecialchars($row['image_path']) .'" alt="'.  '">
            ...
            echo "<p class='alert'>No banquet hall uploaded.</p>";
        }
        $stmt->close();
        ?>
    </div>
    ...
    <?php $conn->close(); ?>
          ...
          <div id="booking-form" class="modal">
              <form class="modal-content animate" action="BanquetHall.php" method="post" name="myForm" onsubmit="return validateForm()" enctype="multipart/form-data">
