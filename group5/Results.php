...
<body>
    ...
    <?php
                ...
                $sql = "SELECT booking_id, user_name, phone_number, hall_name, event_begin, event_end ,status FROM booking WHERE status='Accepted' OR status='Rejected'";
                ...
                if ($result->num_rows > 0) {
                    while ($row = $result->fetch_assoc()) {
                        ...
                        <p class="">Booking ID: <b>' . htmlspecialchars($row['booking_id']) . '</b></p>
                            <span class="user-name">Mr/Mrs: <b>' . htmlspecialchars($row['user_name']) . '</b>  <b>' . htmlspecialchars($row['phone_number']) . '</b> your booking request has been <b>' . htmlspecialchars($row['status']) . '</b> from <b>' . htmlspecialchars($row['event_begin']) . '</b> up to <b>' . htmlspecialchars($row['event_end']) . '</b></span>
                        </div>
