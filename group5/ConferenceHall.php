...
.alert{
  ...
  <body>
    ...
    <ul>
          ...
          <li>
            <a href="ConferenceHall.php" class="active">Conference halls</a>
          </li>
          <li>
          ...
          <h1 class="page-title">Conference Hall</h1>
          <?php
...
echo '<div class="hall-wrapper">
  ...
  <div class="right-col">
        <img src="' . htmlspecialchars($row['image_path']) .'" alt="'.  '">
          ...
          echo "<p class='alert'>No conference hall uploaded.</p>";
        }
        $stmt->close();
        ?>
    </div>
    ...
    <?php $conn->close(); ?>
          ...
          <div id="booking-form" class="modal">
              <form class="modal-content animate" action="ConferenceHall.php" method="post" name="myForm" onsubmit="return validateForm()" enctype="multipart/form-data">
