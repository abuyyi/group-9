  ...
  <body>
    ...
    <nav class="navbar">
        <ul>
          ...
          <li>
            <a href="ConcertHall.php" class="active">Concert halls</a>
          </li>
          <li>
...
echo '<div class="hall-wrapper">
  ...
  <div class="right-col">
        <img src="' . htmlspecialchars($row['image_path']) .'" alt="'.  '">
          ...
          echo "<p class='alert'>No concert hall uploaded.</p>";
        }
        $stmt->close();
        ?>
    </div>
    ...
    <?php $conn->close(); ?>
          ...
          <div id="booking-form" class="modal">
              <form class="modal-content animate" action="ConcertHall.php" method="post" name="myForm" onsubmit="return validateForm()" enctype="multipart/form-data">
